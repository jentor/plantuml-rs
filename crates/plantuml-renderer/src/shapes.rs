...
pub fn actor_path(cx: f64, cy: f64, scale: f64) -> String {
    ...
    let head = format!(
        ...
        cx - head_r, cy - body_h - head_r,
        head_r, head_r, head_r * 2.0,
        head_r, head_r, -head_r * 2.0
    );
...
pub fn database_path(x: f64, y: f64, width: f64, height: f64) -> String {
    ...
    let sides = format!(
        "M{},{} L{},{} M{},{} L{},{}",
        x, y + ellipse_h,
        x, y + height - ellipse_h,
        x + width, y + ellipse_h,
        x + width, y + height - ellipse_h
    );
